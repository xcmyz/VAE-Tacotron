...
class SeqLinear(nn.Module):
    def __init__(self, input_size, output_size, time_dim=2):
        ...
        # time_dim: index of time dimension
    ...
    def forward(self, input_):
        # print("seq shape:" + str(np.shape(input_)))
...
class Prenet(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        # input_size: dimension of input
        # hidden_size: dimension of hidden unit
        # output_size: dimension of output
        ...
        # print({"input": input_size, "hidden": hidden_size, "out": output_size})
    ...
    def forward(self, input_):
        ...
        #        "hidden": self.hidden_size, "out": self.output_size})
...
class CBHG(nn.Module):
    ...
    def __init__(self, hidden_size, K=16, projection_size=128, num_gru_layers=2, max_pool_kernel_size=2, is_post=False):
        ...
        # is_post: whether post processing or not
    ...
    def forward(self, input_):
        ...
        # print(np.shape(highway))
        ##############################
        # highway: (batch, seq_length, features)
        ##############################
...
class AttentionDecoder(nn.Module):
    ...
    def forward(self, decoder_input, memory, attn_hidden, gru1_hidden, gru2_hidden):
        ...
        attn_weights = self.v(torch.tanh(
            keys + d_t_duplicate).view(-1, self.num_units)).view(-1, memory_len, 1)
